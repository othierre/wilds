...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Wilds - Tecnologia e Segurança para o Agricultor Familiar</title>
        <meta name="description" content="A Wilds oferece soluções digitais para o uso seguro de agrotóxicos e EPIs, unindo inovação, educação e sustentabilidade para proteger o agricultor e o meio ambiente." />
        <link rel="canonical" href="https://wilds.app.br/" />
      </Helmet>
